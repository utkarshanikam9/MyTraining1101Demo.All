...
$webMvcFolder = Join-Path $slnFolder "src/MyTraining1101Demo.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/MyTraining1101Demo.Web.Public"
...
dotnet restore MyTraining1101Demo.Web.sln
