...
namespace MyTraining1101Demo.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<MyTraining1101DemoDbContext>>()
            ...
            new MyTraining1101DemoDbContext(builder.Options).Database.EnsureCreated();
        }
