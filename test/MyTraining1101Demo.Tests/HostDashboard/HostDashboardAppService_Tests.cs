...
using MyTraining1101Demo.MultiTenancy.HostDashboard;
...
namespace MyTraining1101Demo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(MyTraining1101DemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
