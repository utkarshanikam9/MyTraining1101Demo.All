...
using MyTraining1101Demo.Web.Startup.ExternalLoginInfoProviders;
...
namespace MyTraining1101Demo.Web.Startup
{
    ...
    public class MyTraining1101DemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MyTraining1101DemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyTraining1101DemoWebHostModule).GetAssembly());
        }
