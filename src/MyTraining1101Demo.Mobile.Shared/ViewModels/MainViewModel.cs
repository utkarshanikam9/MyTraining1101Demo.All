...
using MyTraining1101Demo.Commands;
...
using MyTraining1101Demo.Controls;
using MyTraining1101Demo.Dto;
using MyTraining1101Demo.Extensions;
using MyTraining1101Demo.Localization;
using MyTraining1101Demo.UI;
using MyTraining1101Demo.UI.Assets;
using MyTraining1101Demo.Views;
using DependencyResolver = MyTraining1101Demo.Core.Dependency.DependencyResolver;

namespace MyTraining1101Demo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "MyTraining1101Demo";
