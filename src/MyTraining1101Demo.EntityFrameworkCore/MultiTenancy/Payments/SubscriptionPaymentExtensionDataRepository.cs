...
{
    public class SubscriptionPaymentExtensionDataRepository : MyTraining1101DemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<MyTraining1101DemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
