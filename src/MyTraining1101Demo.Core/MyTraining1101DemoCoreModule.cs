...
using MyTraining1101Demo.Authorization.Ldap;
...
using MyTraining1101Demo.DashboardCustomization.Definitions;
using MyTraining1101Demo.Debugging;
using MyTraining1101Demo.DynamicEntityProperties;
using MyTraining1101Demo.Features;
...
using MyTraining1101Demo.Net.Emailing;
using MyTraining1101Demo.Notifications;
using MyTraining1101Demo.WebHooks;
using Newtonsoft.Json;

namespace MyTraining1101Demo
{
    [DependsOn(
        typeof(MyTraining1101DemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class MyTraining1101DemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            MyTraining1101DemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = MyTraining1101DemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, MyTraining1101DemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<MyTraining1101DemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyTraining1101DemoCoreModule).GetAssembly());
        }
