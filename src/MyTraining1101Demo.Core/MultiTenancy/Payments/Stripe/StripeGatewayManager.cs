...
{
    public class StripeGatewayManager : MyTraining1101DemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "MyTraining1101Demo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + MyTraining1101DemoConsts.Currency;
        }
