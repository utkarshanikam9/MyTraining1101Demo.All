...
using MyTraining1101Demo.DemoUiComponents.Dto;

namespace MyTraining1101Demo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : MyTraining1101DemoAppServiceBase, IDemoUiComponentsAppService
    {
