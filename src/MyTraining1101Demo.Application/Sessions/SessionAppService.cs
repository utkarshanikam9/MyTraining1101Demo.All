...
{
    public class SessionAppService : MyTraining1101DemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = MyTraining1101DemoConsts.Currency,
                        CurrencySign = MyTraining1101DemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = MyTraining1101DemoConsts.AllowTenantsToChangeEmailSettings,
