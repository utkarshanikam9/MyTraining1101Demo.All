...
namespace MyTraining1101Demo.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : MyTraining1101DemoServiceBase, ITransientDependency
    {
