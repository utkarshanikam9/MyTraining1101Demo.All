...
using MyTraining1101Demo.Authorization.Permissions;
using MyTraining1101Demo.Authorization.Permissions.Dto;
using MyTraining1101Demo.Authorization.Roles.Dto;

namespace MyTraining1101Demo.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : MyTraining1101DemoAppServiceBase, IRoleAppService
    {
