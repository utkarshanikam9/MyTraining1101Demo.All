...
using MyTraining1101Demo.Authorization.Users.Profile.Cache;
using MyTraining1101Demo.Authorization.Users.Profile.Dto;
using MyTraining1101Demo.Configuration;
using MyTraining1101Demo.Friendships;
using MyTraining1101Demo.Gdpr;
using MyTraining1101Demo.Net.Sms;
using MyTraining1101Demo.Security;
using MyTraining1101Demo.Storage;
using MyTraining1101Demo.Timing;

namespace MyTraining1101Demo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : MyTraining1101DemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("MyTraining1101Demo",
