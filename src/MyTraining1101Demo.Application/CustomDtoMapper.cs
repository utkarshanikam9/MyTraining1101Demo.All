...
namespace MyTraining1101Demo
{
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
            ...
            //Phone
            configuration.CreateMap<PersonPhone, PhoneInPersonListDto>();

            //configuration.CreateMap<AddPhoneInput, AddPhoneInput>();
            configuration.CreateMap<AddPhoneInput, PersonPhone>();


            configuration.CreateMap<Person, GetPersonForEditOutput>();

            configuration.CreateMap<CustomerEntity, CreateOrEditCustomerDto>().ReverseMap();
            configuration.CreateMap<CustomerEntity, CustomerListDto>();
            configuration.CreateMap<User, UserLookupDto>();
            configuration.CreateMap<CustomerEntity, EditCustomerOutput>();
            configuration.CreateMap<EditCustomerInputDto,CustomerEntity >();
