...
using MyTraining1101Demo.Timing.Dto;
using TimeZoneConverter;

namespace MyTraining1101Demo.Timing
{
    public class TimingAppService : MyTraining1101DemoAppServiceBase, ITimingAppService
    {
