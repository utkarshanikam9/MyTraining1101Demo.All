...
using MyTraining1101Demo.Migrations.Seed.Host;
...
namespace MyTraining1101Demo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : MyTraining1101DemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<MyTraining1101DemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{MyTraining1101DemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{MyTraining1101DemoConsts.ConnectionStringName}", constring);
        }
