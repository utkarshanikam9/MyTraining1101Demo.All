...
using MyTraining1101Demo.Auditing.Exporting;
...
using EntityHistoryHelper = MyTraining1101Demo.EntityHistory.EntityHistoryHelper;

namespace MyTraining1101Demo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : MyTraining1101DemoAppServiceBase, IAuditLogAppService
    {
