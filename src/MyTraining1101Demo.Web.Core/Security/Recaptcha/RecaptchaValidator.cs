...
namespace MyTraining1101Demo.Web.Security.Recaptcha
{
    public class RecaptchaValidator : MyTraining1101DemoServiceBase, IRecaptchaValidator, ITransientDependency
    {
