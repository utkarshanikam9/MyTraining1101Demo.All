...
using MyTraining1101Demo.Web.Configuration;
using MyTraining1101Demo.Web.DashboardCustomization;

namespace MyTraining1101Demo.Web
{
    [DependsOn(
        typeof(MyTraining1101DemoApplicationModule),
        typeof(MyTraining1101DemoEntityFrameworkCoreModule),
    ...
    public class MyTraining1101DemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MyTraining1101DemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(MyTraining1101DemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyTraining1101DemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(MyTraining1101DemoWebCoreModule).Assembly);
        }
