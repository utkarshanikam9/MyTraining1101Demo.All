...
namespace MyTraining1101Demo.Web.Authentication.JwtBearer
{
    public class MyTraining1101DemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public MyTraining1101DemoJwtSecurityTokenHandler()
        {
