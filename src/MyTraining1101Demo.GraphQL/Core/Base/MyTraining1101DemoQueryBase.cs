...
namespace MyTraining1101Demo.Core.Base
{
    public abstract class MyTraining1101DemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected MyTraining1101DemoQueryBase(string fieldName,
