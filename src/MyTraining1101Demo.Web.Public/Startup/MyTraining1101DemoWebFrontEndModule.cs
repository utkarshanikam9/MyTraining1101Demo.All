...
namespace MyTraining1101Demo.Web.Public.Startup
{
    [DependsOn(
        typeof(MyTraining1101DemoWebCoreModule)
    )]
    public class MyTraining1101DemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public MyTraining1101DemoWebFrontEndModule(IWebHostEnvironment env, MyTraining1101DemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyTraining1101DemoWebFrontEndModule).GetAssembly());
        }
    }
}
