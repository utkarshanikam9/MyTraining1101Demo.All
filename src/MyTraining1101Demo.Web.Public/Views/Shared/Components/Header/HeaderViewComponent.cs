...
using MyTraining1101Demo.Web.Public.Startup;
using MyTraining1101Demo.Web.Session;

namespace MyTraining1101Demo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : MyTraining1101DemoViewComponent
    {
